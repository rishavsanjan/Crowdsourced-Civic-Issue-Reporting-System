        ...
        <View className="flex flex-col justify-between h-full bg-[#F6F7F8]">
            <View>
                ...
                <View className='flex flex-col gap-4 m-4'>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('Login')} className='items-center bg-[#1173D4] p-3 rounded-lg'>
                        <Text className='text-white font-medium  text-lg'>Log In</Text>
                    </TouchableOpacity>

                    <TouchableOpacity onPress={() => navigation.navigate('SignUpScreen')} className='bg-[#DFE9F4] items-center p-3 rounded-lg'>
