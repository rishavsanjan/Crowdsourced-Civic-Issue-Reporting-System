...
const HomeScreen: React.FC<Props> = ({ navigation }) => {
    ...
    const getLocation = async () => {
        try {
            ...
            const response = await axios({
                method: 'POST',
                url: `http://10.11.8.198:3000/api/complain/getHomeComplaints`,
                data: {
    ...
    const addVote = async (complaint_id: number, vote_type: 'like' | 'dislike' | null, currentReaction: 'like' | 'dislike' | null) => {
        if (currentReaction === null) {
            ...
            const response = await axios({
                method: 'POST',
                url: `http://10.11.8.198:3000/api/complain/addvote`,
                data: {
                    complaint_id,
                    vote_type
                },
            ...
            const response = await axios({
                method: 'POST',
                url: `http://10.11.8.198:3000/api/complain/updatevote`,
                data: {
                    complaint_id,
                    vote_type
                },
    ...
    const removeVote = async (complaint_id: number, vote_type: 'like' | 'dislike' | null, currentReaction: 'like' | 'dislike' | null) => {
        ...
        const response = await axios({
            method: 'POST',
            url: `http://10.11.8.198:3000/api/complain/removevote`,
            data: {
                complaint_id,
                vote_type
            },
        ...
        <View className="flex-1 bg-[#F6F7F8]">
            ...
            {loading ? (
                <View className="flex-1 justify-center items-center">
                    ...
                    <Text className="mt-2 text-gray-500">Loading complaints...</Text>
                </View>
            ) : (
                <ScrollView
