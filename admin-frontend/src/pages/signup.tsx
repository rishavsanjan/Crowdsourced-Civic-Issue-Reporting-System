                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        <div className="flex items-center gap-3 text-gray-800 light:text-white">
                            ...
                            <h1 className="text-xl font-bold">FixMyCity ADMIN</h1>
                        </div>
                    </div>
                </div>
            </header>
                ...
                <div className="w-full max-w-xl space-y-8">
                    <div className="bg-white light:bg-gray-800 p-8 rounded-xl shadow-2xl space-y-6">
                        ...
                        <div id="onboarding-steps">                            <div className="space-y-6">
                            <div>
                                <label className="block text-sm font-medium text-gray-700 light:text-gray-300" htmlFor="name">Full Name</label>
                                <div className="mt-1">
                                    <input
